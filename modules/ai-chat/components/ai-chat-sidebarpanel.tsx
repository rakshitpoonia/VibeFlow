...
export const AIChatSidePanel: React.FC<AIChatSidePanelProps> = ({
  ...
  // Load KaTeX CSS dynamically to avoid Turbopack parsing issues
  useEffect(() => {
              ...
              <div className="flex-1 overflow-y-auto bg-black">
                <div className="p-6 space-y-6">
                      ...
                      <div className="grid grid-cols-2 gap-3 max-w-sm mx-auto">
                        {[
                          ...
                          <button
                            ...
                            className="px-3 py-3 bg-zinc-800/80 hover:bg-zinc-700 border border-zinc-700/50 rounded-lg text-xs text-zinc-300 transition-all text-left font-medium"
                          >
                            {suggestion}
                          </button>
                        ))}
                  ...
                  {filteredMessages.map((msg) => (
                    <div key={msg.id} className="space-y-4 w-full">
                      <div
                        className={cn(
                      ...
                      >
                        ...
                        <div
                          className={cn(
                            "max-w-[85%] rounded-lg shadow-lg",
                            msg.role === "user"
                              ? "bg-blue-600/90 text-white p-4 rounded-br-none"
                              : "bg-zinc-800/90 text-zinc-100 p-4 rounded-bl-none border border-zinc-700/60",
                          )}
                        >
                          {msg.role === "assistant" && (
